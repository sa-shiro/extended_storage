...
import com.github.sa_shiro.extended_storage.tileentity.DragonChestTileEntity;
...
public class DragonChestContainer extends Container {
    ...
    public final DragonChestTileEntity tileEntity;
    private final IWorldPosCallable canInteractWithCallable;


    public DragonChestContainer(final int windowId, final PlayerInventory playerInventoryIn, final DragonChestTileEntity tileEntity) {
        super(DeferredRegistryEvent.DRAGON_CHEST_CONTAINER.get(), windowId);
        ...
        int startX = 9;
        int startY = 17;
        int playerStartX = 171;
        int playerStartY = 265;
        int hotBarY = 323;
    ...
    public DragonChestContainer(final int windowId, final PlayerInventory playerInventory, final PacketBuffer data) {
        this(windowId, playerInventory, getTileEntity(playerInventory, data));
    }

    private static DragonChestTileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
        Objects.requireNonNull(playerInventory, "playerInventory can't be null!");
        Objects.requireNonNull(data, "data can't be null!");
        final TileEntity tileAtPos = playerInventory.player.world.getTileEntity(data.readBlockPos());
        if (tileAtPos instanceof DragonChestTileEntity) {
            return (DragonChestTileEntity) tileAtPos;
        }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(canInteractWithCallable, playerIn, DeferredRegistryEvent.DRAGON_CHEST.get());
    }
