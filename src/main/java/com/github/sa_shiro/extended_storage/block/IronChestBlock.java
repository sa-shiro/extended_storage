...
public class IronChestBlock extends Block {
    ...
    public IronChestBlock(Material material, SoundType sound, float hardness, float resistance, int harvestLevel) {
    ...
    public static Direction getFacingFromEntity(BlockPos blockPos, LivingEntity entity) {
        return Direction.getFacingFromVector((float) (entity.getPosX() - blockPos.getX()), (float) (entity.getPosY() - blockPos.getY()), (float) (entity.getPosZ() - blockPos.getZ()));
    }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return DeferredRegistryEvent.IRON_CHEST_TILE_ENTITY.get().create();
    }
